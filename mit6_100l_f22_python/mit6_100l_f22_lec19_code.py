...
def make_pets(d):
    ...
    # your code here
    for p,cat in d.items():
        print(p.get_name()+" : "+cat.get_name())
...
class Employee(Person):
    ...
    def __init__(self, name, age,sal=0):
    ...
    def past_salary_freq(self):
        ...
        re = {}
        for s in self.past_salaries_list():
            if s not in re:
                re[s] = 1
            else:
                re[s] += 1
...
def counts(L):
    ...
    return (countp,counte,len(names))
