...
class SwimWorkout(Workout):
    ...
    def __init__(self, start, end, pace=2, calories=None, numlapse=0):
    ...
    def get_average_laptime(self):
        if self.num == 0:
            return None
        return self.get_duration()/self.num
...
ws1 = SwimWorkout("9/30/2021 2:20 pm", "9/30/2021 2:50 pm", numlapse=40) 
# 2) Swim 40 laps

# 3) Print average laptime
print("average ",ws1.get_average_laptime())

# 4) Display workout summary
ws1.end_swim_workout()
