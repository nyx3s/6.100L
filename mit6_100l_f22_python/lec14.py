...
def find_grades(grades, students):
    ...
    # your code here
    return [grades[std] for std in students]
...
def is_inverse(d1, d2):
    ...
    len2 = len(d2)
    if len1 >= len(d2):
        return cheek_inverse(d1,d2)
    else:
        return cheek_inverse(d2,d1)


def cheek_inverse(d1,d2):
...
def add_to_d(d, L):
    ...
    try:
        ...
        raise ValueError("u tried to add non hashuble object as key")
